...
Vue.component('good-list', {
  template: `<section class="product container">
              ...
              <div class="product__list">
                <card v-for="good of list" v-bind:good="good" :key="good.id" @add-to-cart="addToCartHandler"></card>
              </div>
...
Vue.component('cart-products', {
  template: `<div class="cart-products">
              <ul>
              <cart-good v-for="purchasedGood of cart" :key="purchasedGood.id" v-bind:purchasedGood="purchasedGood"></cart-good>
              </ul>
